    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(choices=[("lead", "Lead"), ("agent", "Agent")], default="agent", max_length=20),
                ),
                (
                    "team",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "team",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="assignments", to="teams.team"
                    ),
                ),
                (
                    "agent",
